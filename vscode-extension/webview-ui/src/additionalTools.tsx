  ...
  const renderMarkdown = (text: string): string => {
    ...
    return blocks.map(block => {
      ...
      if (headerMatch) {
        ...
        return `<p style="${headerStyle}">${renderInline(headerText)}</p>${remainder ? renderMarkdown(remainder) : ''}`;
      }
    ...
    <div style={{ padding: "10px", fontFamily: "Poppins, sans-serif" }}>
      <div style={{ marginBottom: "12px" }}>
        ...
        <textarea
          ...
          placeholder="Example: explain what this function does... or summarize this block..."
          style={{
            width: "100%",
            padding: "8px",
            borderRadius: "4px",
